	...
	public void write_globals(Declarations globals) throws IOException{
		for (Declaration global : globals) {
			...
			if (global.t.equals(Type.INT) || global.t.equals(Type.BOOL)
				|| global.t.equals(Type.CHAR)) //MODIFIED 
				  global_sig += " I";	
      else if (global.t.equals(Type.DOUBLE)) { //DOUBLE 
          global_sig += " D"; 
            }
      else if (global.t.equals(Type.FLOAT)){ //Added Float wasnt sure if missing
        global_sig += " F";
      }
			else
				global_sig += " V";
	...
	*/
	public void function_preamble(String func_name, Type return_type, Declarations params, Declarations locals) throws IOException {
		...
		for (Declaration param : params) {
			...
			method_sig += "I";
      else if (param.t.equals(Type.DOUBLE)) //MODIFIED//
      method_sig += "D";
			else
			method_sig += "F";
		}	
		...
		if (return_type.equals(Type.INT) || return_type.equals(Type.CHAR) 
			...
			method_sig += "I";
    else if (return_type.equals(Type.DOUBLE)) //MODIFIED//
    method_sig += "D";
