public class Token {
    ...
    public static final Token doubleTok = new Token(TokenType.Double, "double"); //MODIFIED
    ...
    public static final Token forTok = new Token(TokenType.For, "for"); //MODIFIED
    ...
    public static final Token moduloTok = new Token(TokenType.Modulo, "%"); //MODIFIED
    ...
    public static Token mkDoubleLiteral (String name){ //MODIFIED//
