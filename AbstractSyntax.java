...
class Type {
    ...
    final static Type DOUBLE = new Type("double"); //MODIFIED
	...
	if(this.equals(Type.INT) || this.equals(Type.BOOL) || this.equals(Type.CHAR))
		...
		return "V";
  else if (this.equals(Type.DOUBLE))    //MODIFIED
    return "D";
	else
...
abstract class Value extends Expression {
    ...
    static Value mkValue (Type type) {
        ...
        if(type == Type.DOUBLE) return new DoubleValue( ); //MODIFIED 
...
class DoubleValue extends Value { //MODIFIED 
...
class Operator {
    ...
    final static String MODULO = "%"; //MODIFIED  
    // UnaryOp = !    
    ...
    final static String DOUBLE = "double";  //MODIFIED 
    // Typed Operators
    // RelationalOp = < | <= | == | != | >= | >
    ...
    final static String INT_MODULO = "INT%"; //MODIFIED// 
    final static String INT_NEG = "INT-NEG"; //MODIFIED//
    // RelationalOp = < | <= | == | != | >= | >
    final static String DOUBLE_LT = "DOUBLE<";  //MODIFIED
    ...
    // ArithmeticOp = + | - | * | / | %
    final static String DOUBLE_PLUS = "DOUBLE+";  //MODIFIED
    final static String DOUBLE_MINUS = "DOUBLE-";
    final static String DOUBLE_TIMES = "DOUBLE*";
    final static String DOUBLE_DIV = "DOUBLE/"; 
    final static String DOUBLE_MODULO = "DOUBLE%"; //MODIFIED
    // UnaryOp = !    
    final static String DOUBLE_NEG = "DOUBLE-NEG"; //MODIFIED//
    // RelationalOp = < | <= | == | != | >= | >
    ...
    final static String FLOAT_MODULO = "FLOAT%"; //MODIFIED//
    // UnaryOp = !    
    ...
    final static String I2D = "I2D"; //MODIFIED// line and below
    ...
    boolean ArithmeticOp ( ) {
        return val.equals(PLUS) || val.equals(MINUS)
            || val.equals(TIMES) || val.equals(DIV) || val.equals(MODULO) //MODIFIED 
            || val.equals(INT_PLUS) || val.equals(INT_MINUS)
            || val.equals(INT_TIMES) || val.equals(INT_DIV) || val.equals(INT_MODULO) //MODIFIED 
            || val.equals(FLOAT_PLUS) || val.equals(FLOAT_MINUS)
            || val.equals(FLOAT_TIMES) || val.equals(FLOAT_DIV) || val.equals(FLOAT_MODULO) //MODIFIED 
            || val.equals(DOUBLE_PLUS) || val.equals(DOUBLE_MINUS)
            || val.equals(DOUBLE_TIMES) || val.equals(DOUBLE_DIV) || val.equals(DOUBLE_MODULO); //MODIFIED 
    }
    boolean NotOp ( ) { return val.equals(NOT) ; }
    boolean NegateOp ( ) { return (val.equals(NEG) || val.equals(INT_NEG) || 
				   val.equals(FLOAT_NEG) || val.equals(DOUBLE_NEG)); } //MODIFIED//
    boolean intOp ( ) { return val.equals(INT); }
    boolean floatOp ( ) { return val.equals(FLOAT); }
    boolean charOp ( ) { return val.equals(CHAR); } 
    boolean doubleOp ( ) { return val.equals(DOUBLE); } //MODIFIED//

    final static String intMap[ ] [ ] = {
        {PLUS, INT_PLUS}, {MINUS, INT_MINUS},
        {TIMES, INT_TIMES}, {DIV, INT_DIV}, {MODULO, INT_MODULO}, 
    ...
    final static String floatMap[ ] [ ] = {
        ...
        {TIMES, FLOAT_TIMES}, {DIV, FLOAT_DIV}, {MODULO, FLOAT_MODULO}, 
        {EQ, FLOAT_EQ}, {NE, FLOAT_NE}, {LT, FLOAT_LT},
        {LE, FLOAT_LE}, {GT, FLOAT_GT}, {GE, FLOAT_GE},
        {NEG, FLOAT_NEG}, {INT, F2I}, {DOUBLE, F2D}
    };

    final static String doubleMap[ ] [ ] = { //MODIFIED
        {PLUS, DOUBLE_PLUS}, {MINUS, DOUBLE_MINUS},
        {TIMES, DOUBLE_TIMES}, {DIV, DOUBLE_DIV}, {MODULO, DOUBLE_MODULO}, 
    ...
    final static public Operator doubleMap (String op) { //MODIFIED 
