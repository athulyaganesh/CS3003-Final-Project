...
public class Semantics {
    ...
    Value applyBinary (Operator op, Value v1, Value v2) {
        ...
        if (op.val.equals(Operator.INT_DIV)) 
            return new IntValue(v1.intValue( ) / v2.intValue( )); //MODIFIED 
        if(op.val.equals(Operator.INT_MODULO))
            return new IntValue(v1.intValue() % v2.intValue()); //MODIFED//
        // student exercise
	...
	if (op.val.equals(Operator.INT_NE))
      ...
      //MODIFIED//
        ...
        if(op.val.equals(Operator.DOUBLE_MODULO))
            return new DoubleValue(v1.doubleValue() % v2.doubleValue()); //MODIFIED//
	...
	if (op.val.equals(Operator.FLOAT_PLUS)) 
        ...
        if(op.val.equals(Operator.FLOAT_MODULO))
            return new FloatValue(v1.floatValue() % v2.floatValue()); //MODIFED//
    ...
    Value applyUnary (Operator op, Value v) {
        ...
        if (op.val.equals(Operator.NOT))
        ...
        } else if(op.val.equals(Operator.DOUBLE_NEG)) //MODIFIED//
            ...
            return new DoubleValue((double)(v.intValue())); //MODIFIED//
        else if (op.val.equals(Operator.D2I))
            return new IntValue((int)(v.doubleValue())); //MODIFIED//
