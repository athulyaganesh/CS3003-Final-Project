...
public class TypeTransformer {
  ...
  if (e instanceof Binary) {
        ...
        if (typ1 == Type.INT) {
            ...
            else if (typ2 == Type.DOUBLE) //MODIFIED
        ...
        }else if (typ1 == Type.DOUBLE) { //MODIFIED
	          if (typ2 == Type.INT)	
			          t2 = new Unary (new Operator(Operator.D2I), t2);
                return new Binary(b.op.floatMap(b.op.val), t1,t2);
	...
	if (e instanceof Unary) {
      ...
      else if (typ == Type.DOUBLE) //MODIFIED
    ...
    public static Statement T (Statement s, TypeMap tm) {
	    ...
	    if (a.target instanceof ArrayRef) {
            ...
            if (ttype == Type.FLOAT) {
                ...
                else if (srctype == Type.CHAR) {
                    src = new Unary(new Operator(Operator.C2I), src);
                    srctype = Type.INT;
                }
                else if (srctype == Type.DOUBLE) {
                    src = new Unary(new Operator(Operator.D2I), src);
                    srctype = Type.INT;
                }
            }
